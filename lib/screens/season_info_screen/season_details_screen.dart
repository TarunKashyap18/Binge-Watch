...
import '../../widgets/streaming_player.dart';
            ...
            child: ListView(shrinkWrap: true, children: [
              ...
              DelayedDisplay(
                child: InkWell(
                  ...
                  onTap: () {
                    var url =
                        'https://www.2embed.ru/embed/tmdb/tv?id=$tvShowId&s=${model.seasonNumber}&e=${model.number}';
                    print(url);
                    Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => StreamingPlayer(url: url),
                    ));
                  },
                ),
              ),
